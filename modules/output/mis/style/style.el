...
Returns :mis/nil if none."
  (int<mis>:mlist:entry.get mout :width))
...
Returns updated MOUT list."
  (int<mis>:mlist:entry.set mout :width value))
...
Returns :mis/nil if none."
  (int<mis>:mlist:entry.get mout :margin))
...
Returns updated MOUT list."
  (int<mis>:mlist:entry.set mout :margin value))
...
Returns :mis/nil if none."
  (int<mis>:mlist:entry.get mout :border))
...
Returns updated MOUT list."
  (int<mis>:mlist:entry.set mout :border value))
...
Returns :mis/nil if none."
  (int<mis>:mlist:entry.get mout :padding))
...
Returns updated MOUT list."
  (int<mis>:mlist:entry.set mout :padding value))
...
Returns :mis/nil if none."
  (int<mis>:mlist:entry.get mout :align))
...
Returns updated MOUT list."
  (int<mis>:mlist:entry.set mout :align value))
...
Returns :mis/nil if none."
  (int<mis>:mlist:entry.get mout :boxed))
...
Returns updated MOUT list."
  (int<mis>:mlist:entry.set mout :boxed value))
